...
school_data <- ventilation_data %>%
  mutate(perc_rooms_windows = round(windows/rooms_total * 100, digits = 1),
         perc_rooms_windows_open = round(windows_open/rooms_total * 100, digits = 1),
         perc_rooms_supplyFan = round(supplyFan_total/rooms_total * 100, digits = 1),
         perc_rooms_supplyFan_operational = round(supplyFan_operational/rooms_total * 100, digits = 1),
         perc_rooms_supplyFan_partOperational = round(supplyFan_partOperational/rooms_total * 100, digits = 1),
         perc_rooms_supplyFan_nonOperational = round(supplyFan_nonOperational/rooms_total * 100, digits = 1),
         perc_rooms_exhaustFan = round(exhaustFan_total/rooms_total * 100, digits = 1),
         perc_rooms_exhaustFan_operational = round(exhaustFan_operational/rooms_total * 100, digits = 1),
         perc_rooms_exhaustFan_partOperational = round(exhaustFan_partOperational/rooms_total * 100, digits = 1),
         perc_rooms_exhaustFan_nonOperational = round(exhaustFan_nonOperational/rooms_total * 100, digits = 1),
         perc_rooms_unitVentilator = round(unitVentilator_total/rooms_total * 100, digits = 1),
         perc_rooms_unitVentilator_operational = round(unitVentilator_operational/rooms_total * 100, digits = 1),
         perc_rooms_unitVentilator_partOperational = round(unitVentilator_partOperational/rooms_total * 100, digits = 1),
         perc_rooms_unitVentilator_nonOperational = round(unitVentilator_nonOperational/rooms_total * 100, digits = 1))
